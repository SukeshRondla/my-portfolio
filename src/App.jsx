            ...
            <section className="news-section">
              ...
              <div className="news-list">
                <div className="news-item">
                  ...
                  <div className="news-desc">Presented <b>Alchemy AI</b>, demonstrating enterprise-grade AI agents for SAP environments. Showcased integrations across supply chain workflows, real-time analytics, and automation built using <b>Alchemy's no-code platform</b>.</div>
                </div>
                <div className="news-item">
